...
/**
 * Implementação do campo Accept-Language, esse campo de cabeçalho é muito similar ao Accept, porém restringe
 * uma série de idiomas que são preferidas como resposta.
 * @final
 * @package		rpo
 * @subpackage	http\header\fields
 * @license		http://creativecommons.org/licenses/GPL/2.0/legalcode.pt
