...
/**
 * @brief		HTTP Location
 * @details		Implementação do campo Location que indica o tipo de média do conteúdo.
 * @class		Location
 * @extends		AbstractHTTPHeaderField
 */
class Location extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Location
