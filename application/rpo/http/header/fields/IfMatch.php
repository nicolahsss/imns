...
/**
 * @brief		HTTP If-Match.
 * @details		Implementação do campo If-Match que indica o tipo de média do conteúdo.
 * @class		IfMatch
 * @extends		AbstractHTTPHeaderField
 */
class IfMatch extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP If-Match
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'If-Match' , $value );
	}
}