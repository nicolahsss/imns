...
/**
 * @brief		HTTP Date
 * @details		Implementação do campo Date que indica a data e a hora de origem da mensagem.
 * @class		Date
 * @extends		AbstractHTTPHeaderField
 */
class Date extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Date
