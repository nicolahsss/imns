...
/**
 * @brief		HTTP Retry-After.
 * @details		Implementação do campo Retry-After que indica o tipo de média do conteúdo.
 * @class		RetryAfter
 * @extends		AbstractHTTPHeaderField
 */
class RetryAfter extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Retry-After
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Retry-After' , $value );
	}
}