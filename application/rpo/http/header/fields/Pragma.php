...
/**
 * @brief		HTTP Pragma.
 * @details		Implementação do campo Pragma que indica o tipo de média do conteúdo.
 * @class		Pragma
 * @extends		AbstractHTTPHeaderField
 */
class Pragma extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Pragma
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Pragma' , $value );
	}
}