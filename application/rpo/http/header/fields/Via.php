...
/**
 * @brief		HTTP Via
 * @details		Implementação do campo Via que indica o tipo de média do conteúdo.
 * @class		Via
 * @extends		AbstractHTTPHeaderField
 */
class Via extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Via
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Via' , $value );
	}
}