...
/**
 * @brief		HTTP Max-Forwards.
 * @details		Implementação do campo Max-Forwards que indica o tipo de média do conteúdo.
 * @class		MaxForwards
 * @extends		AbstractHTTPHeaderField
 */
class MaxForwards extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Max-Forwards
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Max-Forwards' , $value );
	}
}