...
/**
 * @brief		HTTP Cache-Control.
 * @details		Implementação do campo Cache-Control que é utilizado diretivas que precisam ser obedecidas pelos
 * mecanismos de cache durante a cadeia de requisição/resposta.
 * @class		CacheControl
 * @extends		AbstractHTTPHeaderField
 */
final class CacheControl extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Cache-Control
