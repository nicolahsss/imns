...
/**
 * @brief		HTTP If-Range.
 * @details		Implementação do campo If-Range que indica o tipo de média do conteúdo.
 * @class		IfRange
 * @extends		AbstractHTTPHeaderField
 */
class IfRange extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP If-Range
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'If-Range' , $value );
	}
}