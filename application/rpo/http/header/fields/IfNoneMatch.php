...
/**
 * @brief		HTTP If-None-Match.
 * @details		Implementação do campo If-None-Match que indica o tipo de média do conteúdo.
 * @class		IfNoneMatch
 * @extends		AbstractHTTPHeaderField
 */
class IfNoneMatch extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP If-None-Match
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'If-None-Match' , $value );
	}
}