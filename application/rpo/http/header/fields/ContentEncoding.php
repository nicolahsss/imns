...
/**
 * @brief		HTTP Content-Encoding.
 * @details		Implementação do campo Content-Encoding que é utilizado como modificador do tipo de media. Quando presente
 * indica que uma codificação adicional foi aplicada ao conteúdo.
 * @class		ContentEncoding
 * @extends		AbstractHTTPHeaderField
 */
final class ContentEncoding extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Content-Encoding
