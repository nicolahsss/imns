...
/**
 * @brief		HTTP Vary.
 * @details		Implementação do campo Vary que indica o tipo de média do conteúdo.
 * @class		Vary
 * @extends		AbstractHTTPHeaderField
 */
class Vary extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Vary
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Vary' , $value );
	}
}