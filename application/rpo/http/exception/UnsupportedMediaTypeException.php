 ...
 * @details		The server is refusing to service the request because the entity of the request is in a
 * format not supported by the requested resource for the requested method.
 * @class		UnsupportedMediaTypeException
 * @extends		AbstractClientException
 */
final class UnsupportedMediaTypeException extends \rpo\http\exception\AbstractClientException {
	/**
