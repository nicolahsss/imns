...
/**
 * @brief		HTTP 411 Length Required.
 * @details		The server refuses to accept the request without a defined Content- Length.
 * <p>
 * The client MAY repeat the request if it adds a valid Content-Length header field containing
 * the length of the message-body in the request message.</p>
 * @class		LengthRequiredException
 * @extends		AbstractClientException
 */
final class LengthRequiredException extends \rpo\http\exception\AbstractClientException {
	/**
