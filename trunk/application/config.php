...
/**
 * Caso a constante PRODUCTION esteja definida, passamos a não mostrar
 * as mensagens de erro; Contudo, em produção, mostraremos tudo, com
 * E_STRICT também habilitado.
 */
