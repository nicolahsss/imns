...
/**
 * @brief		HTTP 413 Request Entity Too Large
 * @details		The server is refusing to process a request because the request entity is larger than the server
 ...
 * temporary and after what time the client MAY try again.</p>
 * @class		RequestEntityTooLargeException
 * @extends		AbstractClientException
 */
final class RequestEntityTooLargeException extends \rpo\http\exception\AbstractClientException {
	/**
