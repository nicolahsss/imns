 ...
 * @details		The server, while acting as a gateway or proxy, received an invalid response
 * from the upstream server it accessed in attempting to fulfill the request.
 * @class		BadGatewayException
 * @extends		AbstractServerException
 */
final class BadGatewayException extends \rpo\http\exception\AbstractServerException {
	/**
