...
/**
 * @brief		HTTP Proxy-Authorization.
 * @details		Implementação do campo Proxy-Authorization que indica o tipo de média do conteúdo.
 * @class		ProxyAuthorization
 * @extends		AbstractHTTPHeaderField
 */
class ProxyAuthorization extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Proxy-Authorization
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Proxy-Authorization' , $value );
	}
}