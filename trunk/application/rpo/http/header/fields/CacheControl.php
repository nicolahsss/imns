...
/**
 * Implementação do campo Cache-Control que é utilizado diretivas que precisam ser obedecidas pelos mecanismos
 * de cache durante a cadeia de requisição/resposta
 * @final
 * @package		rpo
 * @subpackage	http\header\fields
 * @license		http://creativecommons.org/licenses/GPL/2.0/legalcode.pt
