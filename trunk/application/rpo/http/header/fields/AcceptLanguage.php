...
/**
 * @brief		HTTP Accept-Language
 * @details		Implementação do campo Accept-Language, esse campo de cabeçalho é muito similar ao Accept,
 * porém restringe uma série de idiomas que são preferidas como resposta.
 * @class		AcceptLanguage
 * @extends		AbstractHTTPPriorityHeaderField
 * @see			Accept
 */
final class AcceptLanguage extends \rpo\http\header\AbstractHTTPPriorityHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Accept-Language
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Accept-Language' , $value );
	}
