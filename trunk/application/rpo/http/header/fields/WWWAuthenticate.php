...
/**
 * @brief		HTTP WWW-Authenticate
 * @details		Implementação do campo WWW-Authenticate que indica o tipo de média do conteúdo.
 * @class		WWWAuthenticate
 * @extends		AbstractHTTPHeaderField
 */
class WWWAuthenticate extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP WWW-Authenticate
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'WWW-Authenticate' , $value );
	}
}