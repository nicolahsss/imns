...
/**
 * @brief		HTTP Proxy-Authenticate.
 * @details		Implementação do campo Proxy-Authenticate que indica o tipo de média do conteúdo.
 * @class		ProxyAuthenticate
 * @extends		AbstractHTTPHeaderField
 */
class ProxyAuthenticate extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Proxy-Authenticate
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Proxy-Authenticate' , $value );
	}
}