...
/**
 * @brief		HTTP Referer
 * @details		Implementação do campo Referer que indica o tipo de média do conteúdo.
 * @class		Referer
 * @extends		AbstractHTTPHeaderField
 */
class Referer extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Referer
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Referer' , $value );
	}
}