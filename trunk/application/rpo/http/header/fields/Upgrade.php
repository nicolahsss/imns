...
/**
 * @brief		HTTP Upgrade
 * @details		Implementação do campo Upgrade que indica o tipo de média do conteúdo.
 * @class		Upgrade
 * @extends		AbstractHTTPHeaderField
 */
class Upgrade extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Upgrade
	 * @param $protocol string Protocolo que deve ser utilizado
