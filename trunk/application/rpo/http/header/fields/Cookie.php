...
/**
 * @brief		HTTP Cookie.
 * @details		Implementação do campo Cookie.
 * @class		Cookie
 * @extends		AbstractHTTPHeaderField
 */
class Cookie extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Cookie
