...
/**
 * @brief		HTTP If-Modified-Since.
 * @details		Implementação do campo If-Modified-Since que indica o tipo de média do conteúdo.
 * @class		IfModifiedSince
 * @extends		AbstractHTTPHeaderField
 */
class IfModifiedSince extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP If-Modified-Since
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'If-Modified-Since' , $value );
	}
}