...
/**
 * @brief		HTTP Content-Location.
 * @details		Implementação do campo Content-Location que pode ser utilizado para fornecer a localização de um
 * recurso incluído na resposta, quando esse recurso é acessível de uma localização separada.
 * @class		ContentLocation
 * @extends		AbstractHTTPHeaderField
 */
final class ContentLocation extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Content-Location
