...
/**
 * @brief		HTTP Range.
 * @details		Implementação do campo Range que indica o tipo de média do conteúdo.
 * @class		Range
 * @extends		AbstractHTTPHeaderField
 */
class Range extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Range
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Range' , $value );
	}
}