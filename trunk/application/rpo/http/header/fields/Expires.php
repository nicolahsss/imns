...
/**
 * @brief		HTTP Expires
 * @details		Implementação do campo Expires que indica a data e hora em que o conteúdo será considerado obsoleto.
 * Caso o campo Cache-Control contenha a diretiva max-age, esta substituirá o valor de Expires.
 * @class		Expires
 * @extends		AbstractHTTPHeaderField
 */
class Expires extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Expires
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Expires' , $value );
	}
