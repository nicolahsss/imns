...
/**
 * @brief		HTTP Accept-Charset
 * @details		Implementação do campo de requisição Accept-Charset que é utilizado para especificar os
 * tipos de charset que é aceitável para a resposta.
 * @class		AcceptCharset
 * @extends		AbstractHTTPPriorityHeaderField
 */
final class AcceptCharset extends \rpo\http\header\AbstractHTTPPriorityHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Accept-Charset
