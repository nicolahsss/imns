...
/**
 * @brief		HTTP Warning.
 * @details		Implementação do campo Warning que indica o tipo de média do conteúdo.
 * @class		Warning
 * @extends		AbstractHTTPHeaderField
 */
class Warning extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Warning
