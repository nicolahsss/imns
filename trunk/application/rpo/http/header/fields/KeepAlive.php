...
/**
 * @brief		HTTP Keep-Alive
 * @details		Implementação do campo Keep-Alive
 * @class		KeepAlive
 * @extends		AbstractHTTPHeaderField
 */
class KeepAlive extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Keep-Alive
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Keep-Alive' , $value );
	}
}