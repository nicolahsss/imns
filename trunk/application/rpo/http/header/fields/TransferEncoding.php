 ...
 * @details		Implementação do campo Transfer-Encoding que indica o tipo de média do conteúdo.
 * @class		TransferEncoding
 * @extends		AbstractHTTPHeaderField
 */
class TransferEncoding extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Transfer-Encoding
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Transfer-Encoding' , $value );
	}
}