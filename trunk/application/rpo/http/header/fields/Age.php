...
/**
 * @brief		HTTP Age
 * @details		Implementação do campo Age, esse campo de cabeçalho permite ao servidor estimar a idade
 * de um recurso desde quando ela foi gerada ou revalidada.
 * @class		Age
 * @extends		AbstractHTTPPriorityHeaderField
 */
final class Age extends \rpo\http\header\AbstractHTTPPriorityHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Age
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Age' , $value );
	}
