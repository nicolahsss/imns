 ...
 * @details		Implementação do campo Authorization, que consiste nas credenciais utilizadas pelo User-Agent
 * para autenticar no servidor.
 * @class		Authorization
 * @extends		AbstractHTTPHeaderField
 */
class Authorization extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Authorization
