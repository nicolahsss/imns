 ...
 * @details		Implementação do campo Content-Type que indica o tipo de media do conteúdo.
 * @class		ContentType
 * @extends		AbstractHTTPHeaderField
 */
class ContentType extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Content-Type
