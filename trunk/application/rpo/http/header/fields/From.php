...
/**
 * @brief		HTTP From
 * @details		Implementação do campo From que indica o e-mail do cliente.
 * @class		From
 * @extends		AbstractHTTPHeaderField
 */
class From extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP From
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'From' , $value );
	}
	...
	public function accept( $value ) {
		return (bool) preg_match( '/^[^@]+@[a-zA-Z0-9._-]+\.[a-zA-Z]+$/' , $value );
	}
}