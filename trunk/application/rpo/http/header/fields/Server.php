...
/**
 * @brief		HTTP Server.
 * @details		Implementação do campo Server que indica o tipo de média do conteúdo.
 * @class		Server
 * @extends		AbstractHTTPHeaderField
 */
class Server extends \rpo\http\header\AbstractHTTPHeaderField {
	/**
	 * Constroi o objeto que representa o cabeçalho HTTP Server
	 * @param $value string Valor do campo de cabeçalho
	 */
	public function __construct( $value ) {
		parent::__construct( 'Server' , $value );
	}
}